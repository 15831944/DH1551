...
typedef enum
{
	...
	E_UPGRADE_COMMAND_PC_SEND_MAC,
	E_UPGRADE_COMMAND_STB_REQ_PEF,
	E_UPGRADE_COMMAND_PC_SEND_PEF,//0x29

	E_UPGRADE_COMMAND_STB_SEND_WAIT_SEND_UPGRADE_RESULT,//0x2A
	...
	//Verify
	E_UPGRADE_COMMAND_STB_SEND_WAIT_VERIFY,//0x30
	...
	//Repair
	E_UPGRADE_COMMAND_PC_SEND_REQ_RETURNFILE_AGAIN,//0x36
	...
	E_UPGRADE_COMMAND_STB_SEND_UPGRADE_STATUS,//0x3B

	//Conax Personalization
	E_UPGRADE_COMMAND_STB_SEND_PERSONALIZE_COMMAND,//0x3C
