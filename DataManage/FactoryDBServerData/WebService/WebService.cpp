...
//char * mesServer = "http://172.16.9.15/browserWCFServiceAMTC/MyService.asmx";//更改后的测试库
char * mesServer = "http://172.16.9.15/ATSWebservice_GMTC/MyService.asmx";//she
//char* mesServer = "http://172.16.9.112/ATSWebservice_Test/MyService.asmx";//研发库

//char *mesServer = "http://mes.szmtc.com.cn:8070/ATSWebserviceGMTCRD/MyService.asmx";
//char* mesServer = "http://172.16.82.127/ATSWebservice/MyService.asmx";//bisonpc

//char* mesServer = "http://172.16.9.118/ATSWebserviceGMTC/MyService.asmx";//正式库
//char* mesServer = "http://172.16.8.118/ATSWebserviceGMTC/MyService.asmx";//工厂
...
void WebService::WriteErrLog(char* errMessage)
{
	...
	CString strtm = tm.Format("%Y-%m-%d_WebService");
	strtm += _T(".txt");
